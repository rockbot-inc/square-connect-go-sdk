 ...
 * @param optional nil or *BookingsApiListBookingsOpts - Optional Parameters:
     ...
     * @param "CustomerId" (optional.String) -  The [customer](entity:Customer) for whom to retrieve bookings. If this is not set, bookings for all customers are retrieved.
