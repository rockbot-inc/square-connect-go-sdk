...
// Supported custom attribute query expressions for calling the [SearchCatalogItems]($e/Catalog/SearchCatalogItems) endpoint to search for items or item variations.
