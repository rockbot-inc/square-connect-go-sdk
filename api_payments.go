...
type PaymentsApiListPaymentsOpts struct {
    ...
    IsOfflinePayment optional.Bool
...
func (a *PaymentsApiService) ListPayments(ctx context.Context, localVarOptionals *PaymentsApiListPaymentsOpts) (ListPaymentsResponse, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.IsOfflinePayment.IsSet() {
		localVarQueryParams.Add("is_offline_payment", parameterToString(localVarOptionals.IsOfflinePayment.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.OfflineBeginTime.IsSet() {
		localVarQueryParams.Add("offline_begin_time", parameterToString(localVarOptionals.OfflineBeginTime.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.OfflineEndTime.IsSet() {
		localVarQueryParams.Add("offline_end_time", parameterToString(localVarOptionals.OfflineEndTime.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
