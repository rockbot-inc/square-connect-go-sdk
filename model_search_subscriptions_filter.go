...
// Represents a set of query expressions (filters) to narrow the scope of targeted subscriptions returned by  the [SearchSubscriptions]($e/Subscriptions/SearchSubscriptions) endpoint.
